...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.StatusInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).status.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.StatusInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).status.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.StatusInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).status.findFirst(input as any))),

        findMany: procedure.input($Schema.StatusInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).status.findMany(input as any))),
        ...
        count: procedure.input($Schema.StatusInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).status.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.StatusCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.StatusCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.StatusCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.StatusCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.StatusCountArgs>, 'cursor'>,
